...
from src.utils.config import FEATURE_COLUMNS, SALES_FORECASTING_DIR
...
def check_overfitting():
    ...
    features = [c for c in FEATURE_COLUMNS if c in df_feat.columns]
