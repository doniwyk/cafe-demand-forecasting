...
Untuk menentukan arsitektur model, dilakukan perbandingan langsung antara XGBoost dengan objective `count:poisson` dan Random Forest. Random Forest secara implisit meminimasi Mean Squared Error (MSE), sementara XGBoost dikonfigurasi dengan objective Poisson yang memaksimalkan log-likelihood distribusi Poisson. Kedua model dilatih pada data yang sama (101 fitur, 98.149 baris) dan dievaluasi menggunakan backtest expanding window 8 periode. Tabel 4.16 menyajikan hasilnya.
